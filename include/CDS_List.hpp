 ...
 * which provides basic operations such as appending, removing, and accessing elements.
 */
 ...
 * 
 * This class implements a dynamic list (array-like structure) that supports operations 
 * such as adding, removing, and accessing elements. It automatically reallocates memory 
...
public:
     ...
     * 
     * @return The maximum number of elements the list can hold without reallocation.
     */
     ...
     */
    template <class U>
    friend std::ostream &operator<<(std::ostream &stream, const CDS_List<U> &array);
